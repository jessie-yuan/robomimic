...
if __name__ == "__main__":
    ...
    print("==== Overall Trajectory Length Statistics ====")
    all_traj_lengths = np.array(all_traj_lengths)
    print("total transitions: {}".format(np.sum(all_traj_lengths)))
    print("total trajectories: {}".format(all_traj_lengths.shape[0]))
    print("traj length mean: {}".format(np.mean(all_traj_lengths)))
    print("traj length std: {}".format(np.std(all_traj_lengths)))
    print("traj length min: {}".format(np.min(all_traj_lengths)))
    print("traj length max: {}".format(np.max(all_traj_lengths)))