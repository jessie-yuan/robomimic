...
Args:
    ...
    label-demos: if flag is provided, in the video, put the number of the demo on screen
...
def playback_dataset(args):
    ...
    if not args.use_obs:
        ...
        env_meta = FileUtils.get_env_metadata_from_dataset(dataset_path=args.dataset)
        #remove the "env_name" key from the "env_kwargs" dict
        # env_meta["env_kwargs"].pop("env_name", None)
        #add "light_physics": false to the "env_kwargs" dict
